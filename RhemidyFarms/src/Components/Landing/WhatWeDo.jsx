...
//       >
//         <h3 className="text-emerald-700 text-4xl sm:text-5xl font-bold">
//           What We Do
//         </h3>
//       </motion.div>
...
//       {/* Poultry Section */}
//       <motion.div
//         className="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-24 mb-16"
...
//             src={PoultryImage}
//             alt="Poultry Farming"
//             className="w-full md:w-[500px] h-auto md:h-[400px] object-cover rounded-3xl shadow-xl transform hover:scale-105 transition-transform duration-300"
//           />
//         </motion.div>
...
//           variants={itemVariants}
//         >
//           <h3 className="text-emerald-700 text-3xl font-semibold mb-4">
//             Sustainable Poultry
//           </h3>
//           <p className="max-w-xl mx-auto md:mx-0 text-gray-700 text-lg leading-relaxed">
//             At Rhemidy Farms, we specialize in sustainable poultry farming,
//             providing fresh, high-quality chicken products to our community. Our
//             commitment to ethical farming practices ensures that our poultry is
//             raised in a healthy environment, free from antibiotics and hormones.
//           </p>
//         </motion.div>
//       </motion.div>
...
//       <motion.div
//         className="flex flex-col md:flex-row-reverse items-center justify-center gap-12 lg:gap-24 mb-16"
//         variants={containerVariants}
//         initial="hidden"
//         whileInView="visible"
//         viewport={{ once: true, amount: 0.5 }}
...
//         >
//           <h3 className="text-emerald-700 text-3xl font-semibold mb-4">
//             Expertly grill your fish/chicken to perfection
//           </h3>
//           <p className="max-w-xl mx-auto md:mx-0 text-gray-700 text-lg leading-relaxed">
//             At Rhemidy Farms, we take pride in offering expertly grilled fish
//             and chicken, seasoned to perfection with our signature blend of
//             spices. Whether you're hosting a family gathering or enjoying a
//             quiet meal, our grilling process ensures a smoky, flavorful
//             experience that highlights the natural taste of our fresh,
//             sustainably farmed produce. Enjoy a healthy, delicious option that
